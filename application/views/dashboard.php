...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
      <h1 style="font-family:'Garamond',serif;font-variant:small-caps; font-size:30px; color:black;">
        Dashboard
    
      </h1>
      <ol class="breadcrumb" style="font-family:'Courier New',Monospace;font-variant: small-caps;font-weight: lighter;font-size:20px; color:black;">
    ...
    <!-- Main content -->
    <section class="content" style="font-family:'Courier New',Monospace;font-variant: small-caps;font-weight: lighter;">
