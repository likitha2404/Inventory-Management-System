...
<div class="content-wrapper">
  ...
  <section class="content-header" style="color:#222831;">
    <h1>
      Add New Orders
      <small></small>
    </h1>
    <ol class="breadcrumb" style="font-family:'Courier New',Monospace;font-variant: small-caps;font-weight: lighter;font-size:20px;">
        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Time: <?php date_default_timezone_set('Asia/Kolkata'); echo date('h:i:s a'); ?></label>
                </div>
